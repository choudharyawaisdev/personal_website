        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-6 order-2 order-lg-1">
                ...
                <h1 data-aos="fade-up" data-aos-delay="200">
                    Hello, I'm <span class="highlight">Choudhary Awais</span>
                </h1>

                <h2 data-aos="fade-up" data-aos-delay="300">
                    Professional 
                    <span class="typed" data-typed-items="Web Developer, Laravel Specialist, Backend Engineer, Business Logic Developer"></span>
                </h2>

                <p data-aos="fade-up" data-aos-delay="400">
                    I build reliable and scalable web applications with a strong focus on backend logic,
                    clean code, and real business requirements. My goal is to deliver practical solutions
                    that help businesses grow without unnecessary complexity.
                </p>
            ...
            <div class="col-lg-6 order-1 order-lg-2">
                ...
                <div class="image-wrapper">
                    <img src="assets/img/profile/choudhary_awais_pic.png" alt="Choudhary Awais - Web Developer" class="img-fluid">
